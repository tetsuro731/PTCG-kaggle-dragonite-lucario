"""Adopted feature v4 with opponent Active damage projections."""
...
STATE_NAMES = base.STATE_NAMES + INCOMING_STATE_NAMES
...
class Features:
    def __init__(self, obs, deck: list[int] | None = None, runtime_state=None):
        ...
        self.state = self.base.state + self._incoming_state()
